...
//========================================================================__BLUR_SHADOW_01__===================  
    glBindFramebuffer(GL_FRAMEBUFFER, generic_01_FBO); //generic_01_TEXTURE
        //----------------------------------------------------------------
        //==================================
        radial_OCC_blur_OFFSET_1[0] = 9.5 * 1920.0/1080.0;
        radial_OCC_blur_OFFSET_1[1] = 3.3;
        
        radial_OCC_blur_OFFSET_2[0] = 7.7 * 1920.0/1080.0;
        radial_OCC_blur_OFFSET_2[1] = 6.1;        
        
        radial_OCC_blur_OFFSET_3[0] = 5.7 * 1920.0/1080.0;
        radial_OCC_blur_OFFSET_3[1] = 8.3;          
        
        radial_OCC_blur_OFFSET_4[0] = 3.2 * 1920.0/1080.0;
    ...
    glBindFramebuffer(GL_FRAMEBUFFER, generic_02_FBO); //generic_02_TEXTURE
        //----------------------------------------------------------------
        //============================
        radial_OCC_blur_OFFSET_1[0] = -3.2 * 1920.0/1080.0;
        radial_OCC_blur_OFFSET_1[1] =  9.7;
        
        radial_OCC_blur_OFFSET_2[0] = -5.2 * 1920.0/1080.0;
        radial_OCC_blur_OFFSET_2[1] =  8.5;        
        
        radial_OCC_blur_OFFSET_3[0] = -7.5 * 1920.0/1080.0;
        radial_OCC_blur_OFFSET_3[1] =  6.5;          
        
        radial_OCC_blur_OFFSET_4[0] = -9.3 * 1920.0/1080.0;
    ...
    glBindFramebuffer(GL_FRAMEBUFFER, generic_03_FBO); //generic_02_TEXTURE
        //----------------------------------------------------------------
        //============================
        radial_OCC_blur_OFFSET_1[0] = -1.0 * 1920.0/1080.0;
        radial_OCC_blur_OFFSET_1[1] = -3.9;
        
        radial_OCC_blur_OFFSET_2[0] = -8.0 * 1920.0/1080.0;
        radial_OCC_blur_OFFSET_2[1] = -7.0;        
        
        radial_OCC_blur_OFFSET_3[0] = -5.5 * 1920.0/1080.0;
        radial_OCC_blur_OFFSET_3[1] = -8.4;          
        
        radial_OCC_blur_OFFSET_4[0] = -2.0 * 1920.0/1080.0;
    ...
    glBindFramebuffer(GL_FRAMEBUFFER, generic_04_FBO); //generic_02_TEXTURE
        //----------------------------------------------------------------
        //============================
        radial_OCC_blur_OFFSET_1[0] =  2.9 * 1920.0/1080.0;
        radial_OCC_blur_OFFSET_1[1] = -9.5;
        
        radial_OCC_blur_OFFSET_2[0] =  4.2 * 1920.0/1080.0;
        radial_OCC_blur_OFFSET_2[1] = -8.8;        
        
        radial_OCC_blur_OFFSET_3[0] =  8.2 * 1920.0/1080.0;
